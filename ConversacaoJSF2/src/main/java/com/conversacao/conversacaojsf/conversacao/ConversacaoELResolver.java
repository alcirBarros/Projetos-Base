package com.conversacao.conversacaojsf.conversacao;
...
/**
 * Implementa��o de ELResolver que ser� respons�vel por encontrar os objetos
 * guardados no escopo "conversacao"
 *
