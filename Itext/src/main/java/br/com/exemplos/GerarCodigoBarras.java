...
public class GerarCodigoBarras {
     ...
     * The resulting PDF.
     */
    private static final String RESULT = "/tmp/teste.pdf";
    ...
    public static void main(String[] args) throws IOException, DocumentException {
        new GerarCodigoBarras().teste(RESULT);
    }

    public static void teste(String filename) {
        System.out.println("Barcode Linha de Código ");

        Rectangle rectangle = new Rectangle(112, 85);
        ...
        try {
            ...
            codeEAN.setCode("978021614434423");

            Image imageEAN = codeEAN.createImageWithBarcode(cb, null, null);
            imageEAN.setAbsolutePosition(15, 5);
            //imageEAN.setSpacingBefore(10);
            //imageEAN.scaleAbsoluteWidth(0);

//            PdfPCell celula = new PdfPCell();
//            celula.setBorder(1);
//            celula.setPhrase(null);

            //Phrase phrase = new Phrase(new Chunk(imageEAN, -20, -30));
