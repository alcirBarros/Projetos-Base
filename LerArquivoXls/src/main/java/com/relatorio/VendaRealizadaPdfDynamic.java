...
public class VendaRealizadaPdfDynamic implements IRelatorioDynamicReports {
    ...
    public JasperReportBuilder geraRelatorioCom(Object... obj) {
        ...
        TextColumnBuilder<String> columnLaboratorio = col.column("Laboratorio", "laboratorio", type.stringType()).setWidth(10).setHorizontalAlignment(HorizontalAlignment.LEFT).setStyle(columnPedding);
        ...
        return report
                ...
                .columns(columnVendedor, columnLaboratorio, columnQuantidade, columnValorTotal)
                .columnGrid(columnLaboratorio, columnQuantidade, columnValorTotal)
                .sortBy(asc(columnVendedor), asc(columnLaboratorio))
    ...
    public JRDataSource createDataSource(Object obj) {
        ...
        DRDataSource dataSource = new DRDataSource("vendedor", "laboratorio", "quantidade", "valorTotal");
        List<Source> sourceList = movimentacaoProdutoService.ListaProdutoMovimentacaoVendaRealizada();

        for (Source sourceMovimentacao : sourceList) {
            ...
            dataSource.add(vnd_nome, lab_descricao, pmv_quantidade.intValue(), pmv_valor_total);
        }
